...
<head>
  ...
  <style>
    /* Self-hosted fonts — eliminates CDN latency and sandboxed-env fallback */
    @font-face {
...
{{DEMO_LINKS}}
  ...
  <div class="claude-window">
    ...
    <div class="title-card" id="titleCard">
      ...
      <p class="title-tagline" style="font-size: 20px; color: var(--text-secondary);">47 unreads. A database outage. A jammed printer.</p>
      <p style="margin-top: 16px; font-size: 15px; color: var(--text-muted);">What if your AI could read your Slack?</p>
      <p class="title-version" style="margin-top: 20px; font-size: 12px;">Slack MCP Server · No OAuth · One command</p>
    </div>
    ...
    <div class="closing-card" id="closingCard">
      ...
      <p class="closing-cta" style="font-size: 14px; color: var(--text-secondary); margin-bottom: 20px;">The printer PIN is 4729.</p>

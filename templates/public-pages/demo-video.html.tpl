...
<head>
  ...
  <style>
    @font-face { font-family: "Space Grotesk"; src: url("fonts/space-grotesk-500.woff2") format("woff2"); font-display: swap; }
    ...
    :root { color-scheme: dark; --ground:#090c13; --surface:#111620; --rule:#303948; --paper:#f2eee6; --muted:#929cab; --coral:#ff6b6b; --teal:#4ecdc4; --display:Georgia,"Iowan Old Style","Times New Roman",serif; --body:"IBM Plex Sans",system-ui,sans-serif; --mono:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; }
    * { box-sizing: border-box; }
    ...
    .eyebrow { margin:0 0 14px; color:var(--coral); font-family:var(--mono); font-size:11px; letter-spacing:.14em; text-transform:uppercase; }
    ...
    .duration { color:var(--teal); font-family:var(--mono); font-size:14px; text-align:right; }
    ...
    .mode.active { color:var(--teal); border-color:var(--teal); background:#102029; }
    ...
    .chapter.active { box-shadow:inset 0 -2px var(--teal); }
    ...
    .install code { padding:14px 16px; border:1px solid var(--teal); color:var(--teal); background:#102029; font-family:var(--mono); font-size:12px; white-space:nowrap; }
    .install a { display:flex; align-items:center; padding:0 16px; background:var(--teal); color:#071214; font-weight:600; text-decoration:none; font-size:13px; }

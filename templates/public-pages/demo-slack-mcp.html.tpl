  ...
  <style>
    ...
    * {
    ...
    .skeleton-avatar {
      ...
      height: 28px;
      border-radius: 50%;
      background: linear-gradient(90deg, var(--window-border) 25%, #26303f 50%, var(--window-border) 75%);
    ...
    .message.user .message-avatar {
      background: linear-gradient(135deg, #2b3648 0%, #3a4a63 100%);
      color: white;
      font-weight: 600;
      font-size: 12px;
    }
    ...
    .message.user .message-sender { color: #b8c2d0; }
    ...
    .title-card h1 .accent-time { color: var(--coral); }
    .title-card .chan { color: var(--teal); font-weight: 600; }
    ...
    .closing-tally .from { color: var(--coral); }
    .closing-tally .to { color: var(--teal); }
    .closing-tally .arrow {
      color: var(--text-muted);
      font-size: 0.52em;

...
{{DEMO_LINKS}}
  ...
  <div class="claude-window">
    ...
    <div class="title-card" id="titleCard">
      ...
      <p class="title-line" style="font-size: 18px; color: var(--text-secondary); line-height: 1.6;">A jammed printer. Nobody knows the PIN.<br>The guy who did left six months ago.</p>
      <p class="title-line" style="margin-top: 24px; font-size: 16px; color: var(--claude-orange); font-weight: 500;">His message is still in #facilities.</p>

...
{{DEMO_LINKS}}
  ...
  <div class="claude-window">
    ...
    <div class="title-card" id="titleCard">
      ...
      <p class="title-line" style="font-size: 18px; color: var(--text-secondary); line-height: 1.6;">A jammed printer. Nobody knows the PIN.<br>The guy who did quit six months ago.</p>

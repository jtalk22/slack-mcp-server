...
<head>
  ...
  <link rel="canonical" href="{{GITHUB_PAGES_ROOT}}/public/demo.html">
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .preview-banner {
      ...
      border-image: linear-gradient(90deg, #e5482f 0%, #e5482f 34%, #ffb224 66%, #ffb224 100%) 1;
      color: #f0efe9;
      padding: 12px 20px;
      text-align: center;
      font-size: 14px;
    ...
    .avatar.dm { background: rgba(229, 72, 47, 0.16); color: #e5482f; }
    .avatar.channel { background: rgba(255, 178, 36, 0.16); color: #ffb224; }

...
- Public demo pages now use canonical media assets (`demo-slack-mcp.webm`, `demo-slack-mcp.gif`) with refreshed screenshots/poster output.
- Mobile layouts were tightened across `public/index.html`, `public/demo.html`, `public/demo-slack-mcp.html`, and `public/demo-video.html` for 360px/390px viewports.
